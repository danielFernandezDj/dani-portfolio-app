...
export default function TLCLicensing() {
  const cardData = CardsData().filter(
    (element) => element.id === 0 || element.id === 2
  );
  ...
  return (
    <>
      <main className="container mx-auto px-4 flex flex-col gap-20 md:gap-20">
        ...
        >
          <strong className="text-5xl">TLC Licensing</strong>
          <p className="text-center px-4 md:w-4/6">
            A comprehensive web platform integrating cutting-edge front-end,
            back-end, and database technologies with secure, robust server
            infrastructure to deliver a seamless and reliable user experience.
          </p>
          <img
        ...
        <section className="flex flex-col gap-4 md:w-4/6 m-auto text-slate-800 md:p-8 px-4 py-8 bg-white rounded-2xl">
          <div className="md:text-center">
            <strong className="text-3xl mb-2">Project Purpose and Goal</strong>
            <p>
              This project encompassed three critical phases of site development
              and integration:
            </p>
          </div>
          <div className="flex flex-col gap-4">
            <div>
              ...
              <p>
                Establishing a secure connection between the front-end
                application and back-end system, protecting against potential
                cyber threats. The previous application had been vulnerable,
                experiencing over 1,000 hacking attempts monthly. Our primary
                goal was to implement robust security measures that would shield
            ...
            <div>
              ...
              <p>
                Developing the most effective strategy to maintain a stable and
                secure connection between the server and database. This involved
                implementing advanced encryption protocols and creating multiple
                layers of authentication to prevent potential breaches.
              </p>
            </div>
            <div>
              <p className="text-xl" style={{ color: textColor.colorXL }}>
              ...
              <p>
                Designing a sophisticated system focused on server entry point
                security, ensuring data integrity and protection. We developed
                comprehensive security protocols that monitor, filter, and
                validate all incoming and outgoing data transactions.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="flex flex-col gap-4 md:w-4/6 m-auto text-slate-800">
          ...
          <p>
            ...
            efficient working environment. Its component-based architecture
            allows for dynamic and responsive user interfaces that can easily
            communicate with server-side resources.
          </p>
          <p>
            For the complexity of transactions and account management, we
            utilized React Hooks with Redux to centralize and organize all cart
            items and user tasks in a single, cohesive state management system.
            This approach provides a robust and predictable way to handle
            complex application logic, enabling efficient data flow and user
            experience.
          </p>
        ...
        >
          ...
          <ol className="flex flex-col gap-4 list-decimal list-inside">
            <li>
              I could spend hours describing the invaluable lessons learned
              while working on this project. The most significant insights came
              from my deep dive into React Hooks, Git management, Feature Keys,
              and API integration. As my first large-scale React project, it
              became a transformative learning experience that reshaped my
