...
export default function ShieldAI() {
  ...
  const cardData = CardsData().filter(
    (element) => element.id === 0 || element.id === 1
  );
      ...
      <div className="flex flex-col gap-4 m-auto mt-10 md:w-4/6">
        ...
        <section className="flex flex-col gap-4 bg-slate-800 p-4 rounded-2xl">
          <div>
            ...
            <strong className="text-2xl text-gradient">Shield.ai</strong>
          </div>
          <p className="w-full md:w-4/6">
            Shield.ai is created to help U.S community to learn more about low &
            human rights.
          </p>
          <img
