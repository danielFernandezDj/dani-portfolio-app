                ...
                <form ref={form} onSubmit={sendEmail}>
                    ...
                    <div className="flex flex-row gap-4">
                        <div className="mb-4">
                            ...
                            <input type="text" id="name" name="user_name" className="w-full p-3 text-slate-200 border rounded-sm shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-slate-300"
                                placeholder="Enter your name" required
                            />
                        </div>
                        <div className="mb-4">
                            <label htmlFor="phone" className="block text-slate-200 mb-2">Phone</label>
                            <input type="text" id="phone" name="user_phone" className="w-full p-3 text-slate-200 border rounded-sm shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-slate-300"
                    ...
                    <div className="mb-4">
                        ...
                        <textarea id="message" name="message" className="w-full p-3 text-slate-200 border rounded-sm shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-slate-300"
                            placeholder="Enter your message" rows="4" required>
                        </textarea>
                    </div>
                    <div className="text-center w-full">
                        <button type="submit" className="rounded-sm p-3 px-5 btn-hover-animation border border-slate-600 tracking-wider">
